...
const values = [
  {
    ...
    description: 'We blend theory with real-world experience to prepare students for dynamic business challenges.'
  },
  {
    icon: <Lightbulb className="h-8 w-8 text-orange-500" />, 
    title: 'Practical Innovation',
    description: 'We encourage hands-on learning, creativity, and problem-solving.'
  },
  // {
  //   icon: <Users className="h-8 w-8 text-green-600" />, 
  //   title: 'Collaborative Growth',
  //   description: 'We foster teamwork, leadership, and a supportive academic community.'
  // },
];
    ...
    <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-10 md:gap-16 items-start">
      ...
      <div className="flex-1 min-w-0">
        ...
        {/* <div className="text-center md:text-left mb-10 animate-fadeIn">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4 tracking-tight drop-shadow-lg">Our Mission</h1>
          <p className="text-lg md:text-xl text-blue-900 font-medium max-w-2xl mx-auto md:mx-0">
            To promote excellence in management and technical education, equipping students with both theoretical knowledge and real industrial experience to prepare them for the dynamic business world.
          </p>
        </div> */}
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 border border-blue-100 animate-fadeInUp mb-8">
          ...
          <p className="text-gray-700 text-lg leading-relaxed mb-4">
            We are committed to nurturing future leaders by providing a holistic education that blends academic rigor with practical exposure, fostering innovation, ethics, and a spirit of collaboration.
          </p>
          <ul className="list-disc pl-6 text-gray-600 text-base">
            <li>Deliver industry-relevant curriculum and experiential learning.</li>
            <li>Encourage research, creativity, and entrepreneurial thinking.</li>
            <li>Build a diverse, inclusive, and supportive academic environment.</li>
          </ul>
        </div>

        <div className="bg-gradient-to-r from-blue-100 to-blue-50 rounded-xl shadow p-6 md:p-8 text-center animate-fadeInUp">
          <blockquote className="italic text-blue-800 text-lg md:text-xl mb-4">“Our mission is to empower students with the knowledge, skills, and values needed to thrive in a rapidly changing world and to contribute meaningfully to society.”</blockquote>
